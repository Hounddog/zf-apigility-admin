...
angular.module('ag-admin').controller(
    ...
    function ($scope, $state, $stateParams, flash, DoctrineAdapterResource, doctrineAdapters, agFormHandler) {
        ...
        $scope.saveDoctrineAdapter = function(index) {
            ...
            DoctrineAdapterResource.saveAdapter(doctrineAdapter.adapter_name, options).then(
                function (doctrineAdapter) {
        ...
        $scope.removeDoctrineAdapter = function(adapter_name) {
            DoctrineAdapterResource.removeAdapter(adapter_name).then(function() {
                updateDoctrineAdapters(true, 'Doctrine adapter ' + adapter_name + ' reset');
